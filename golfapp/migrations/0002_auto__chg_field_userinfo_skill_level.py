...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserInfo.skill_level'
        db.alter_column(u'golfapp_userinfo', 'skill_level', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'UserInfo.skill_level'
        db.alter_column(u'golfapp_userinfo', 'skill_level', self.gf('django.db.models.fields.CharField')(max_length=15))
